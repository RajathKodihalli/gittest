...
#include <QMessageBox>
#include <QMetaEnum>
HistPlotGraph::HistPlotGraph(QWidget *parent) :
    QWidget(parent)
{
...
void HistPlotGraph::resizeCustomplot()
{
customPlot->replot();
}

void HistPlotGraph::setScreenSize(int w,int h)
{
...
void HistPlotGraph::getDataFromDM(double d)
{
 pStimulateData= d;
}

void HistPlotGraph::resizeEvent( QResizeEvent *e )
{
...
void HistPlotGraph::setupRealtimeData(QCustomPlot *customPlot)
{
...
connect(&dataTimer, SIGNAL(timeout()), this, SLOT(histDataPlotSlot()));
//dataTimer.start(100); // Interval 0 means to refresh as fast as possible
}

void HistPlotGraph::histDataPlotSlot()
{
...
void HistPlotGraph::bracketDataSlot()
{
...
void HistPlotGraph::showCursorDataDialog(QMouseEvent *event)
{
...
void HistPlotGraph::resumePlotGraph()
{
// dataTimer.start(100);
 qDebug() << "Timer Stop";
 customPlot->replot();
